...
def main() -> None:
    ...
    lines = [
        ...
        '<title id="title">The 4C AI Harness Ladder</title>',
        ...
        '<text x="56" y="105" fill="#2457FF" font-family="SFMono-Regular,Menlo,monospace" font-size="18" font-weight="700" letter-spacing="3">OPEN-SOURCE CODE AUDIT / 2026-08-19</text>',
        '<text x="52" y="163" fill="#101826" font-family="Arial Narrow,Helvetica Neue,Arial,sans-serif" font-size="62" font-weight="900" letter-spacing="-2">THE 4C AI HARNESS LADDER</text>',
        '<text x="56" y="198" fill="#53657A" font-family="Helvetica Neue,Arial,sans-serif" font-size="19">15 leading open-source Harnesses · One candidate-blind source exam</text>',
